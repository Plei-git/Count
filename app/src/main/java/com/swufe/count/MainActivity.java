...
//            n1 = Double.parseDouble(operatorNumber);
//        }
...
//        double d1 = Double.parseDouble(bundle.getString("s1"));
//        double d2 = Double.parseDouble(bundle.getString("s2"));
//        String operator = bundle.getString("op");
//            double result = 0;
//                    if (op.equals("+")) {
//                        result = d1 + d2;
//                    } else if (op.equals("-")) {
...
//                    }
//                  if (!s1.equals("operator") && s2.equals("")) {
//                    input.setText(str);
//                } else if (s1.equals("operator") && !s2.equals("")) {
